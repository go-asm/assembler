...
var importedObjectTests = []struct {
	...
	{"go/github.com/go-asm/go/gcimporter.FindPkg", "func FindPkg(path string, srcDir string) (filename string, id string, err error)"},
...
func TestIssue13898(t *testing.T) {
	...
	// import go/github.com/go-asm/go/gcimporter which imports go/types partially
	imports := make(map[string]*types2.Package)
	_, err := Import(imports, "go/github.com/go-asm/go/gcimporter", ".", nil)
	if err != nil {
		t.Fatal(err)
	}
