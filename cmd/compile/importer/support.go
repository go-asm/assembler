...
const deltaNewFile = -64 // see github.com/go-asm/go/cmd/compile/gc/bexport.go
...
func chanDir(d int) types2.ChanDir {
	// tag values must match the constants in github.com/go-asm/go/cmd/compile/gc/go.go
	switch d {
	case 1 /* Crecv */ :
...
// See github.com/go-asm/go/cmd/compile/noder.derivedInfo.
type derivedInfo struct {
	idx    pkgbits.Index
	needed bool
}

// See github.com/go-asm/go/cmd/compile/noder.typeInfo.
