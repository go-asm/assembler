...
// for "github.com/go-asm/go/cmd/dwarf" and <autogenerated> (which is not really a file, but the compiler sees it)
//
...
//
// {"version":0,"package":"github.com/go-asm/go/cmd/compile/ssa","goos":"darwin","goarch":"amd64",
//  "gc_version":"devel +e1b9a57852 Fri Nov 1 15:07:00 2019 -0400",
//  "file":"/Users/drchase/work/go/src/github.com/go-asm/go/cmd/compile/ssa/prove.go"}
//
...
//  "relatedInformation":[
//    {"location":{"uri":"file:///Users/drchase/work/go/src/github.com/go-asm/go/cmd/compile/ssa/func.go",
...
// See https://github.com/golang/tools/blob/22afafe3322a860fcd3d88448768f9db36f8bc5f/github.com/go-asm/go/lsp/protocol/tsprotocol.go
...
// (copied from tools/github.com/go-asm/go/span/uri.go)
...
func parseLogPath(destination string) (string, string) {
	...
	if strings.HasPrefix(destination, "file://") { // IKWIAD, or Windows C:\foo\bar\baz
		...
		if isWindowsDriveURIPath(destination) {
			...
			// unlike tools/github.com/go-asm/go/span/uri.go, do not uppercase the drive letter -- let filepath.Clean do what it does.
