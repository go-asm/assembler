...
import (
	"github.com/go-asm/go/cmd/compile/loopvar/testdata/inlines/a"
	"github.com/go-asm/go/cmd/compile/loopvar/testdata/inlines/b"
	"github.com/go-asm/go/cmd/compile/loopvar/testdata/inlines/c"
	"fmt"
	"os"
)
