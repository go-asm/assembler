...
See [github.com/go-asm/go/cmd/compile/types/type.go](../types/type.go) for more information.
...
After changing the rules or operators, run `go generate github.com/go-asm/go/cmd/compile/ssa`
