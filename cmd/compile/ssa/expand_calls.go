...
func (x *expandState) rewriteSelect(leaf *Value, selector *Value, offset int64, regOffset Abi1RO) []*LocalSlot {
	...
	case OpLoad: // We end up here because of IData of immediate structures.
		...
		//
		// GOSSAFUNC='(*dumper).dump' go build -gcflags=-l -tags=math_big_pure_go github.com/go-asm/go/cmd/compile/gc
		// github.com/go-asm/go/cmd/compile/gc/dump.go:136:14: internal compiler error: '(*dumper).dump': not lowered: v827, StructSelect PTR PTR
		// b2: ← b1
