...
import (
	...
	rtabi "github.com/go-asm/go/abi"
)
...
func (s *state) stmt(n ir.Node) {
	...
	case ir.OINTERFACESWITCH:
		...
		if base.Flag.N == 0 && rtabi.UseInterfaceSwitchCache(Arch.LinkArch.Name) {
			...
			if _, ok := intrinsics[intrinsicKey{Arch.LinkArch.Arch, "runtime/github.com/go-asm/go/atomic", "Loadp"}]; !ok {
...
func InitTables() {
	...
	addF("runtime/github.com/go-asm/go/math", "MulUintptr",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
			if s.config.PtrSize == 4 {
	...
	addF("runtime/github.com/go-asm/go/sys", "Bswap32",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
			return s.newValue1(ssa.OpBswap32, types.Types[types.TUINT32], args[0])
		},
		brev_arch...)
	addF("runtime/github.com/go-asm/go/sys", "Bswap64",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
	...
	addF("runtime/github.com/go-asm/go/sys", "Prefetch", makePrefetchFunc(ssa.OpPrefetchCache),
		sys.AMD64, sys.ARM64, sys.PPC64)
	addF("runtime/github.com/go-asm/go/sys", "PrefetchStreamed", makePrefetchFunc(ssa.OpPrefetchCacheStreamed),
		sys.AMD64, sys.ARM64, sys.PPC64)

	/******** runtime/github.com/go-asm/go/atomic ********/
	addF("runtime/github.com/go-asm/go/atomic", "Load",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
	...
	addF("runtime/github.com/go-asm/go/atomic", "Load8",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
		...
		sys.AMD64, sys.ARM64, sys.Loong64, sys.MIPS, sys.MIPS64, sys.PPC64, sys.RISCV64, sys.S390X)
	addF("runtime/github.com/go-asm/go/atomic", "Load64",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
	...
	addF("runtime/github.com/go-asm/go/atomic", "LoadAcq",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
		...
		sys.PPC64, sys.S390X)
	addF("runtime/github.com/go-asm/go/atomic", "LoadAcq64",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
		...
		sys.PPC64)
	addF("runtime/github.com/go-asm/go/atomic", "Loadp",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
	...
	addF("runtime/github.com/go-asm/go/atomic", "Store",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
			s.vars[memVar] = s.newValue3(ssa.OpAtomicStore32, types.TypeMem, args[0], args[1], s.mem())
			return nil
		},
		sys.AMD64, sys.ARM64, sys.Loong64, sys.MIPS, sys.MIPS64, sys.PPC64, sys.RISCV64, sys.S390X)
	addF("runtime/github.com/go-asm/go/atomic", "Store8",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
			s.vars[memVar] = s.newValue3(ssa.OpAtomicStore8, types.TypeMem, args[0], args[1], s.mem())
			return nil
		},
		sys.AMD64, sys.ARM64, sys.Loong64, sys.MIPS, sys.MIPS64, sys.PPC64, sys.RISCV64, sys.S390X)
	addF("runtime/github.com/go-asm/go/atomic", "Store64",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
			s.vars[memVar] = s.newValue3(ssa.OpAtomicStore64, types.TypeMem, args[0], args[1], s.mem())
			return nil
		},
		sys.AMD64, sys.ARM64, sys.Loong64, sys.MIPS64, sys.PPC64, sys.RISCV64, sys.S390X)
	addF("runtime/github.com/go-asm/go/atomic", "StorepNoWB",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
			s.vars[memVar] = s.newValue3(ssa.OpAtomicStorePtrNoWB, types.TypeMem, args[0], args[1], s.mem())
			return nil
		},
		sys.AMD64, sys.ARM64, sys.Loong64, sys.MIPS, sys.MIPS64, sys.RISCV64, sys.S390X)
	addF("runtime/github.com/go-asm/go/atomic", "StoreRel",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
			s.vars[memVar] = s.newValue3(ssa.OpAtomicStoreRel32, types.TypeMem, args[0], args[1], s.mem())
			return nil
		},
		sys.PPC64, sys.S390X)
	addF("runtime/github.com/go-asm/go/atomic", "StoreRel64",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
	...
	addF("runtime/github.com/go-asm/go/atomic", "Xchg",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
	...
	addF("runtime/github.com/go-asm/go/atomic", "Xchg64",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
	...
	addF("runtime/github.com/go-asm/go/atomic", "Xadd",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
		...
		sys.AMD64, sys.Loong64, sys.MIPS, sys.MIPS64, sys.PPC64, sys.RISCV64, sys.S390X)
	addF("runtime/github.com/go-asm/go/atomic", "Xadd64",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
	...
	addF("runtime/github.com/go-asm/go/atomic", "Cas",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
		...
		sys.AMD64, sys.Loong64, sys.MIPS, sys.MIPS64, sys.PPC64, sys.RISCV64, sys.S390X)
	addF("runtime/github.com/go-asm/go/atomic", "Cas64",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
		...
		sys.AMD64, sys.Loong64, sys.MIPS64, sys.PPC64, sys.RISCV64, sys.S390X)
	addF("runtime/github.com/go-asm/go/atomic", "CasRel",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
			v := s.newValue4(ssa.OpAtomicCompareAndSwap32, types.NewTuple(types.Types[types.TBOOL], types.TypeMem), args[0], args[1], args[2], s.mem())
			s.vars[memVar] = s.newValue1(ssa.OpSelect1, types.TypeMem, v)
			return s.newValue1(ssa.OpSelect0, types.Types[types.TBOOL], v)
	...
	addF("runtime/github.com/go-asm/go/atomic", "And8",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
			s.vars[memVar] = s.newValue3(ssa.OpAtomicAnd8, types.TypeMem, args[0], args[1], s.mem())
			return nil
		},
		sys.AMD64, sys.MIPS, sys.MIPS64, sys.PPC64, sys.RISCV64, sys.S390X)
	addF("runtime/github.com/go-asm/go/atomic", "And",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
			s.vars[memVar] = s.newValue3(ssa.OpAtomicAnd32, types.TypeMem, args[0], args[1], s.mem())
			return nil
		},
		sys.AMD64, sys.MIPS, sys.MIPS64, sys.PPC64, sys.RISCV64, sys.S390X)
	addF("runtime/github.com/go-asm/go/atomic", "Or8",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
			s.vars[memVar] = s.newValue3(ssa.OpAtomicOr8, types.TypeMem, args[0], args[1], s.mem())
			return nil
		},
		sys.AMD64, sys.ARM64, sys.MIPS, sys.MIPS64, sys.PPC64, sys.RISCV64, sys.S390X)
	addF("runtime/github.com/go-asm/go/atomic", "Or",
		func(s *state, n *ir.CallExpr, args []*ssa.Value) *ssa.Value {
	...
	alias("runtime/github.com/go-asm/go/atomic", "Loadint32", "runtime/github.com/go-asm/go/atomic", "Load", all...)
	alias("runtime/github.com/go-asm/go/atomic", "Loadint64", "runtime/github.com/go-asm/go/atomic", "Load64", all...)
	alias("runtime/github.com/go-asm/go/atomic", "Loaduintptr", "runtime/github.com/go-asm/go/atomic", "Load", p4...)
	alias("runtime/github.com/go-asm/go/atomic", "Loaduintptr", "runtime/github.com/go-asm/go/atomic", "Load64", p8...)
	alias("runtime/github.com/go-asm/go/atomic", "Loaduint", "runtime/github.com/go-asm/go/atomic", "Load", p4...)
	alias("runtime/github.com/go-asm/go/atomic", "Loaduint", "runtime/github.com/go-asm/go/atomic", "Load64", p8...)
	alias("runtime/github.com/go-asm/go/atomic", "LoadAcq", "runtime/github.com/go-asm/go/atomic", "Load", lwatomics...)
	alias("runtime/github.com/go-asm/go/atomic", "LoadAcq64", "runtime/github.com/go-asm/go/atomic", "Load64", lwatomics...)
	alias("runtime/github.com/go-asm/go/atomic", "LoadAcquintptr", "runtime/github.com/go-asm/go/atomic", "LoadAcq", p4...)
	alias("sync", "runtime_LoadAcquintptr", "runtime/github.com/go-asm/go/atomic", "LoadAcq", p4...) // linknamed
	alias("runtime/github.com/go-asm/go/atomic", "LoadAcquintptr", "runtime/github.com/go-asm/go/atomic", "LoadAcq64", p8...)
	alias("sync", "runtime_LoadAcquintptr", "runtime/github.com/go-asm/go/atomic", "LoadAcq64", p8...) // linknamed

	// Aliases for atomic store operations
	alias("runtime/github.com/go-asm/go/atomic", "Storeint32", "runtime/github.com/go-asm/go/atomic", "Store", all...)
	alias("runtime/github.com/go-asm/go/atomic", "Storeint64", "runtime/github.com/go-asm/go/atomic", "Store64", all...)
	alias("runtime/github.com/go-asm/go/atomic", "Storeuintptr", "runtime/github.com/go-asm/go/atomic", "Store", p4...)
	alias("runtime/github.com/go-asm/go/atomic", "Storeuintptr", "runtime/github.com/go-asm/go/atomic", "Store64", p8...)
	alias("runtime/github.com/go-asm/go/atomic", "StoreRel", "runtime/github.com/go-asm/go/atomic", "Store", lwatomics...)
	alias("runtime/github.com/go-asm/go/atomic", "StoreRel64", "runtime/github.com/go-asm/go/atomic", "Store64", lwatomics...)
	alias("runtime/github.com/go-asm/go/atomic", "StoreReluintptr", "runtime/github.com/go-asm/go/atomic", "StoreRel", p4...)
	alias("sync", "runtime_StoreReluintptr", "runtime/github.com/go-asm/go/atomic", "StoreRel", p4...) // linknamed
	alias("runtime/github.com/go-asm/go/atomic", "StoreReluintptr", "runtime/github.com/go-asm/go/atomic", "StoreRel64", p8...)
	alias("sync", "runtime_StoreReluintptr", "runtime/github.com/go-asm/go/atomic", "StoreRel64", p8...) // linknamed

	// Aliases for atomic swap operations
	alias("runtime/github.com/go-asm/go/atomic", "Xchgint32", "runtime/github.com/go-asm/go/atomic", "Xchg", all...)
	alias("runtime/github.com/go-asm/go/atomic", "Xchgint64", "runtime/github.com/go-asm/go/atomic", "Xchg64", all...)
	alias("runtime/github.com/go-asm/go/atomic", "Xchguintptr", "runtime/github.com/go-asm/go/atomic", "Xchg", p4...)
	alias("runtime/github.com/go-asm/go/atomic", "Xchguintptr", "runtime/github.com/go-asm/go/atomic", "Xchg64", p8...)

	// Aliases for atomic add operations
	alias("runtime/github.com/go-asm/go/atomic", "Xaddint32", "runtime/github.com/go-asm/go/atomic", "Xadd", all...)
	alias("runtime/github.com/go-asm/go/atomic", "Xaddint64", "runtime/github.com/go-asm/go/atomic", "Xadd64", all...)
	alias("runtime/github.com/go-asm/go/atomic", "Xadduintptr", "runtime/github.com/go-asm/go/atomic", "Xadd", p4...)
	alias("runtime/github.com/go-asm/go/atomic", "Xadduintptr", "runtime/github.com/go-asm/go/atomic", "Xadd64", p8...)

	// Aliases for atomic CAS operations
	alias("runtime/github.com/go-asm/go/atomic", "Casint32", "runtime/github.com/go-asm/go/atomic", "Cas", all...)
	alias("runtime/github.com/go-asm/go/atomic", "Casint64", "runtime/github.com/go-asm/go/atomic", "Cas64", all...)
	alias("runtime/github.com/go-asm/go/atomic", "Casuintptr", "runtime/github.com/go-asm/go/atomic", "Cas", p4...)
	alias("runtime/github.com/go-asm/go/atomic", "Casuintptr", "runtime/github.com/go-asm/go/atomic", "Cas64", p8...)
	alias("runtime/github.com/go-asm/go/atomic", "Casp1", "runtime/github.com/go-asm/go/atomic", "Cas", p4...)
	alias("runtime/github.com/go-asm/go/atomic", "Casp1", "runtime/github.com/go-asm/go/atomic", "Cas64", p8...)
	alias("runtime/github.com/go-asm/go/atomic", "CasRel", "runtime/github.com/go-asm/go/atomic", "Cas", lwatomics...)
	...
	addF("math/bits", "TrailingZeros8",
		...
		sys.S390X)
	alias("math/bits", "ReverseBytes64", "runtime/github.com/go-asm/go/sys", "Bswap64", all...)
	alias("math/bits", "ReverseBytes32", "runtime/github.com/go-asm/go/sys", "Bswap32", all...)
	...
	alias("runtime/github.com/go-asm/go/math", "Mul64", "math/bits", "Mul64", p8...)
	...
	alias("runtime/github.com/go-asm/go/math", "Add64", "math/bits", "Add64", all...)
	...
	alias("runtime/github.com/go-asm/go/sys", "TrailingZeros8", "math/bits", "TrailingZeros8", all...)
	alias("runtime/github.com/go-asm/go/sys", "TrailingZeros32", "math/bits", "TrailingZeros32", all...)
	alias("runtime/github.com/go-asm/go/sys", "TrailingZeros64", "math/bits", "TrailingZeros64", all...)
	alias("runtime/github.com/go-asm/go/sys", "Len8", "math/bits", "Len8", all...)
	alias("runtime/github.com/go-asm/go/sys", "Len64", "math/bits", "Len64", all...)
	alias("runtime/github.com/go-asm/go/sys", "OnesCount64", "math/bits", "OnesCount64", all...)

	/******** sync/atomic ********/

	// Note: these are disabled by flag_race in findIntrinsic below.
	alias("sync/atomic", "LoadInt32", "runtime/github.com/go-asm/go/atomic", "Load", all...)
	alias("sync/atomic", "LoadInt64", "runtime/github.com/go-asm/go/atomic", "Load64", all...)
	alias("sync/atomic", "LoadPointer", "runtime/github.com/go-asm/go/atomic", "Loadp", all...)
	alias("sync/atomic", "LoadUint32", "runtime/github.com/go-asm/go/atomic", "Load", all...)
	alias("sync/atomic", "LoadUint64", "runtime/github.com/go-asm/go/atomic", "Load64", all...)
	alias("sync/atomic", "LoadUintptr", "runtime/github.com/go-asm/go/atomic", "Load", p4...)
	alias("sync/atomic", "LoadUintptr", "runtime/github.com/go-asm/go/atomic", "Load64", p8...)

	alias("sync/atomic", "StoreInt32", "runtime/github.com/go-asm/go/atomic", "Store", all...)
	alias("sync/atomic", "StoreInt64", "runtime/github.com/go-asm/go/atomic", "Store64", all...)
	// Note: not StorePointer, that needs a write barrier.  Same below for {CompareAnd}Swap.
	alias("sync/atomic", "StoreUint32", "runtime/github.com/go-asm/go/atomic", "Store", all...)
	alias("sync/atomic", "StoreUint64", "runtime/github.com/go-asm/go/atomic", "Store64", all...)
	alias("sync/atomic", "StoreUintptr", "runtime/github.com/go-asm/go/atomic", "Store", p4...)
	alias("sync/atomic", "StoreUintptr", "runtime/github.com/go-asm/go/atomic", "Store64", p8...)

	alias("sync/atomic", "SwapInt32", "runtime/github.com/go-asm/go/atomic", "Xchg", all...)
	alias("sync/atomic", "SwapInt64", "runtime/github.com/go-asm/go/atomic", "Xchg64", all...)
	alias("sync/atomic", "SwapUint32", "runtime/github.com/go-asm/go/atomic", "Xchg", all...)
	alias("sync/atomic", "SwapUint64", "runtime/github.com/go-asm/go/atomic", "Xchg64", all...)
	alias("sync/atomic", "SwapUintptr", "runtime/github.com/go-asm/go/atomic", "Xchg", p4...)
	alias("sync/atomic", "SwapUintptr", "runtime/github.com/go-asm/go/atomic", "Xchg64", p8...)

	alias("sync/atomic", "CompareAndSwapInt32", "runtime/github.com/go-asm/go/atomic", "Cas", all...)
	alias("sync/atomic", "CompareAndSwapInt64", "runtime/github.com/go-asm/go/atomic", "Cas64", all...)
	alias("sync/atomic", "CompareAndSwapUint32", "runtime/github.com/go-asm/go/atomic", "Cas", all...)
	alias("sync/atomic", "CompareAndSwapUint64", "runtime/github.com/go-asm/go/atomic", "Cas64", all...)
	alias("sync/atomic", "CompareAndSwapUintptr", "runtime/github.com/go-asm/go/atomic", "Cas", p4...)
	alias("sync/atomic", "CompareAndSwapUintptr", "runtime/github.com/go-asm/go/atomic", "Cas64", p8...)

	alias("sync/atomic", "AddInt32", "runtime/github.com/go-asm/go/atomic", "Xadd", all...)
	alias("sync/atomic", "AddInt64", "runtime/github.com/go-asm/go/atomic", "Xadd64", all...)
	alias("sync/atomic", "AddUint32", "runtime/github.com/go-asm/go/atomic", "Xadd", all...)
	alias("sync/atomic", "AddUint64", "runtime/github.com/go-asm/go/atomic", "Xadd64", all...)
	alias("sync/atomic", "AddUintptr", "runtime/github.com/go-asm/go/atomic", "Xadd", p4...)
	alias("sync/atomic", "AddUintptr", "runtime/github.com/go-asm/go/atomic", "Xadd64", p8...)
...
// descriptor is a compiler-allocated github.com/go-asm/go/abi.TypeAssert whose address is passed to runtime.typeAssert when
