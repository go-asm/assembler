...
func calcStructOffset(errtype *Type, t *Type, o int64, flag int) int64 {
	...
	//
	// This logic is duplicated in go/types and github.com/go-asm/go/cmd/compile/types2.
...
func isAtomicStdPkg(p *Pkg) bool {
	return (p.Prefix == "sync/atomic" || p.Prefix == `""` && base.Ctxt.Pkgpath == "sync/atomic") ||
		(p.Prefix == "runtime/github.com/go-asm/go/atomic" || p.Prefix == `""` && base.Ctxt.Pkgpath == "runtime/github.com/go-asm/go/atomic")
}
...
func CalcSize(t *Type) {
	...
	case TSTRUCT:
		...
		// Recognize and mark runtime/github.com/go-asm/go/sys.nih as not-in-heap.
		if sym := t.Sym(); sym != nil && sym.Pkg.Path == "runtime/github.com/go-asm/go/sys" && sym.Name == "nih" {
			t.SetNotInHeap(true)
		}
