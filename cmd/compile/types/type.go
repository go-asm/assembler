...
// Object represents an ir.Node, but without needing to import github.com/go-asm/go/cmd/compile/ir,
...
// Keep in sync with github.com/go-asm/go/cmd/compile/walk/convert.go:soleComponent.
