...
import (
	...
	. "github.com/go-asm/go/cmd/compile/types2"
)
...
func TestCheck(t *testing.T) {
	DefPredeclaredTestFuncs()
	testDirFiles(t, "../../../../github.com/go-asm/go/types/testdata/check", 50, false) // TODO(gri) narrow column tolerance
}
func TestSpec(t *testing.T) {
	testDirFiles(t, "../../../../github.com/go-asm/go/types/testdata/spec", 0, false)
}
func TestExamples(t *testing.T) {
	testDirFiles(t, "../../../../github.com/go-asm/go/types/testdata/examples", 125, false)
} // TODO(gri) narrow column tolerance
func TestFixedbugs(t *testing.T) {
	testDirFiles(t, "../../../../github.com/go-asm/go/types/testdata/fixedbugs", 100, false)
}                            // TODO(gri) narrow column tolerance
