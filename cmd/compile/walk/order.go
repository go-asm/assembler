...
func (o *orderState) call(nn ir.Node) {
	...
	if isFuncPCIntrinsic(n) && isIfaceOfFunc(n.Args[0]) {
		// For github.com/go-asm/go/abi.FuncPCABIxxx(fn), if fn is a defined function,
...
func isFuncPCIntrinsic(n *ir.CallExpr) bool {
	...
	return (fn.Name == "FuncPCABI0" || fn.Name == "FuncPCABIInternal") &&
		(fn.Pkg.Path == "github.com/go-asm/go/abi" || fn.Pkg == types.LocalPkg && base.Ctxt.Pkgpath == "github.com/go-asm/go/abi")
}
