...
var deptab = []struct {
	...
	{"github.com/go-asm/go/cmd/go/cfg", []string{
		"zdefaultcc.go",
		"zosarch.go",
	}},
	{"runtime/github.com/go-asm/go/sys", []string{
		"zversion.go",
	}},
	{"go/build", []string{
		"zcgo.go",
...
func cmdbootstrap() {
	...
	checkNotStale(goBootstrap, append(toolchain, "runtime/github.com/go-asm/go/sys")...)
