...
var bootstrapDirs = []string{
	...
	"cmd/cgo",
	"cmd/compile",
	"github.com/go-asm/go/cmd/compile/...",
	...
	"github.com/go-asm/go/pkgbits",
	"github.com/go-asm/go/profile",
	"github.com/go-asm/go/race",
	"github.com/go-asm/go/saferio",
	"github.com/go-asm/go/platform",
	"github.com/go-asm/go/types/errors",
...
func bootstrapBuildTools() {
	...
	mkbuildcfg(pathf("%s/src/github.com/go-asm/go/buildcfg/zbootstrap.go", goroot))
	mkobjabi(pathf("%s/src/github.com/go-asm/go/cmd/objabi/zbootstrap.go", goroot))
	...
	// such as in github.com/go-asm/go/cmd/notsha256.
	cmd := []string{
...
var ssaRewriteFileSubstring = filepath.FromSlash("src/github.com/go-asm/go/cmd/compile/ssa/rewrite")

// isUnneededSSARewriteFile reports whether srcFile is a
// src/github.com/go-asm/go/cmd/compile/ssa/rewriteARCHNAME.go file for an
