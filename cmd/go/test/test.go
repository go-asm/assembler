...
import (
	...
	"github.com/go-asm/go/cmd/go/cache"
	"github.com/go-asm/go/cmd/go/cfg"
	"github.com/go-asm/go/cmd/go/load"
	"github.com/go-asm/go/cmd/go/lockedfile"
	...
	"github.com/go-asm/go/cmd/go/work"
	"github.com/go-asm/go/cmd/test2json"
...
func runTest(ctx context.Context, cmd *base.Command, args []string) {
	...
	if testFuzz != "" {
		...
		// github.com/go-asm/go/fuzz packages concurrently with fuzzing.
		var skipInstrumentation = map[string]bool{
			"context":                   true,
			"github.com/go-asm/go/fuzz": true,
			"reflect":                   true,
			"runtime":                   true,
			"sync":                      true,
			"sync/atomic":               true,
