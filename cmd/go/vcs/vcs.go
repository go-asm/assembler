...
import (
	...
	"github.com/go-asm/go/singleflight"
	...
	"github.com/go-asm/go/cmd/go/web"
...
var (
	...
	// github.com/go-asm/go/cmd/go/vcweb.Server.
...
func interceptVCSTest(repo string, vcs *Cmd, security web.SecurityMode) (repoURL string, ok bool) {
	...
	if vcs == vcsMod {
		...
		// requests will be intercepted at a lower level (in github.com/go-asm/go/cmd/go/web).
		return "", false
	}
...
// on github.com/go-asm/go/cmd/go/load. It just needs to satisfy load.ImportPathError.
