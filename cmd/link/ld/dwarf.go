...
// rules for dwarf.Sym from the github.com/go-asm/go/cmd/dwarf package. DwDie and
...
func dwarfGenerateDebugInfo(ctxt *Link) {
	...
	for _, typ := range []string{
		"type:github.com/go-asm/go/abi.Type",
		"type:github.com/go-asm/go/abi.ArrayType",
		"type:github.com/go-asm/go/abi.ChanType",
		"type:github.com/go-asm/go/abi.FuncType",
		"type:github.com/go-asm/go/abi.MapType",
		"type:github.com/go-asm/go/abi.PtrType",
		"type:github.com/go-asm/go/abi.SliceType",
		"type:github.com/go-asm/go/abi.StructType",
		"type:github.com/go-asm/go/abi.InterfaceType",
		"type:runtime.itab",
		"type:github.com/go-asm/go/abi.Imethod"} {
