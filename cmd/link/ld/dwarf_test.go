...
import (
	...
	intdwarf "github.com/go-asm/go/cmd/dwarf"
	"github.com/go-asm/go/cmd/link/dwtest"
	objfilepkg "github.com/go-asm/go/cmd/objfile" // renamed to avoid conflict with objfile function
)
...
func TestRuntimeTypesPresent(t *testing.T) {
	...
	want := map[string]bool{
		"github.com/go-asm/go/abi.Type":          true,
		"github.com/go-asm/go/abi.ArrayType":     true,
		"github.com/go-asm/go/abi.ChanType":      true,
		"github.com/go-asm/go/abi.FuncType":      true,
		"github.com/go-asm/go/abi.MapType":       true,
		"github.com/go-asm/go/abi.PtrType":       true,
		"github.com/go-asm/go/abi.SliceType":     true,
		"github.com/go-asm/go/abi.StructType":    true,
		"github.com/go-asm/go/abi.InterfaceType": true,
		"runtime.itab":                           true,
	}
