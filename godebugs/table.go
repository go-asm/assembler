...
// for use by a variety of other packages, including github.com/go-asm/go/godebug,
// runtime, runtime/metrics, and github.com/go-asm/go/cmd/go/load.
package godebugs
...
type Info struct {
	...
	Opaque  bool   // setting does not export information to runtime/metrics using [github.com/go-asm/go/godebug.Setting.IncNonDefault]
}
