...
const zosarchTmpl = `// Code generated by go test github.com/go-asm/go/platform -fix. DO NOT EDIT.

// To change the information in this file, edit the cgoEnabled and/or firstClass
// maps in cmd/dist/build.go, then run 'go generate github.com/go-asm/go/platform'.
